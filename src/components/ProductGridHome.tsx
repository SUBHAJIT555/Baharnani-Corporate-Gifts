...
const products: ProductCategory[] = [
  {
    ...
    link: "/products/construction-materials",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    link: "/products/contracting-solutions",
  },
  {
    id: "5",
    ...
    image:
      ImportExportImage,
    link: "/products/import-and-export",
  },
  {
    id: "6",
    ...
    image:
      ElectronicsITImage,
    link: "/products/electronics-and-it",
  },
  {
    id: "7",
    ...
    image:
      ChemicalsImage,
    link: "/products/chemicals-additives",
  },
  {
    id: "8",
    title: "Eco friendly",
      ...
      <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16 max-w-[1920px] mx-auto">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-tanker text-textcolor leading-tight mb-3 sm:mb-4 md:mb-5 lg:mb-6">
            ...
            <MdOutlineBusinessCenter className="inline-block align-middle rotate-45" />
            Categories in Dubai
          </h2>
