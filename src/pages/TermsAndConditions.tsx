        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10 md:mb-12">
            ...
            <p className="text-base md:text-lg font-switzer text-textcolor leading-relaxed mb-4">
              ...
              stationery, eco-friendly products, promotional giveaways, and tech
              accessories. Designed for corporate events, employee recognition,
              and client appreciation, the gifts are tailored to reflect brand
              identity and enhance business relationships. With a focus on
              quality and customization, Baharnani Gifts ensures that each
          ...
          <section className="mb-10 md:mb-12">
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-tanker text-textcolor mb-3 md:mb-4 mt-4">
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-tanker text-textcolor mb-3 md:mb-4 mt-6">
          ...
          <section className="mb-10 md:mb-12">
            ...
            <p className="text-base md:text-lg font-switzer text-textcolor leading-relaxed mb-4">
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                https://corporategiftsdubaii.ae/privacy-policy/
              </a>
              . By using the Services, you agree to be bound by our Privacy
              Policy, which is incorporated into these Legal Terms. Please be
              advised the Services are hosted in the United Arab Emirates. If
              you access the Services from any other region of the world with
              ...
              Arab Emirates, then through your continued use of the Services,
              you are transferring your data to the United Arab Emirates, and
              you expressly consent to have your data transferred to and
              processed in the United Arab Emirates.
            </p>
          </section>
          ...
          <section className="mb-10 md:mb-12">
            ...
            <p className="text-base md:text-lg font-switzer text-textcolor leading-relaxed mb-4">
              ...
              place, or arbitration shall be Dubai, United Arab Emirates. The
